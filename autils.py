# ⚠️ Note: This file is modified for use in Google Colab with Google Drive.
# Upload this file directly to the appropriate folder in your Google Drive.
# Make sure to update any file paths accordingly to match your Drive structure.
...
plt.style.use('/content/drive/MyDrive/Colab Notebooks/Course 2/Week 2/deeplearning.mplstyle')
